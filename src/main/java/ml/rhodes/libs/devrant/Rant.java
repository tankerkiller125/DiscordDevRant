...
public class Rant extends RantContent {
    ...
    protected Rant(DevRant devRant, int id, User user, int score, int voteState, String text, Image image, List<String> tags, int commentCount) {
        super(devRant, id, user, score, voteState, text, image);
        this.tags = tags;
