...
import ml.rhodes.libs.devrant.exceptions.NotACollabException;
...
public class Collab extends Rant {
    ...
    protected Collab(DevRant devRant, int id, User user, int score, int voteState, String projectType, String summary, int commentCount) {
        super(devRant, id, user, score, voteState, summary, null, Collections.emptyList(), commentCount);
